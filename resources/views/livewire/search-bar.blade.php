...
<div>
    <div class="relative">
        <input
            ...
            class="block w-full py-2 px-4 pr-10 text-sm text-gray-900 placeholder-gray-400 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
        >
                        ...
                        <form class="cursor-default"
                            ...
                            <td class="border py-2 px-4">
                                ...
                                <a href="{{ route('contact.edit', ['id' => $contact->id]) }}"
                                        ...
                                        class="text-white bg-gradient-to-r from-cyan-400 via-cyan-500 to-cyan-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-cyan-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">
                                        Edit
